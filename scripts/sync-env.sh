...
# Proactive spoken announcements when a background Alexa task finishes after the sync budget.
ALEXA_PROACTIVE_ANNOUNCE_ENABLED=${ALEXA_PROACTIVE_ANNOUNCE_ENABLED:-true}
HOME_ASSISTANT_ALEXA_NOTIFY_SERVICE=${HOME_ASSISTANT_ALEXA_NOTIFY_SERVICE:-}
HOME_ASSISTANT_ALEXA_DND_ENTITY=${HOME_ASSISTANT_ALEXA_DND_ENTITY:-}
